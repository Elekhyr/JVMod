...
namespace Math
{
	...
	struct Vec4
	{
		...
		Vec4(const Vec2<T>& rhs, T z = 0, T w = 0); /// Parameterized constructor from 2 arithmetic values 
		// ReSharper disable once CppNonExplicitConvertingConstructor
		Vec4(const Vec3<T>& rhs, T w = 0); /// Parameterized constructor from 2 arithmetic values 
